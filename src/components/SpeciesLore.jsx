                                ...
                                {['Medium', 'Small'].map((size) => (
                                    <label key={size} className={`flex flex-1 items-center gap-2 cursor-pointer p-3 rounded border transition-colors bg-gray-800/20 ${data.size === size ? 'border-brand-500 text-brand-400' : 'border-gray-600 hover:border-brand-500/50'}`}>
                                        <input
                                            ...
                                            className="hidden"
                                        />
                                        <div className={`w-4 h-4 rounded-full border flex items-center justify-center mr-1 ${data.size === size ? 'border-brand-400 bg-brand-500/10' : 'border-gray-500'}`}>
                                            {data.size === size && <div className="w-2 h-2 rounded-full bg-white shadow-[0_0_8px_rgba(255,255,255,0.4)]"></div>}
                                        </div>
