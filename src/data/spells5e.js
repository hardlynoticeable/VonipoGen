...
export const SPELL_LIST = {
    ...
    Cleric: {
        ...
        1: ['Animal Friendship', 'Bane', 'Bless', 'Burning Hands', 'Ceremony', 'Charm Person', 'Command', 'Create or Destroy Water', 'Cure Wounds', 'Detect Evil and Good', 'Detect Magic', 'Detect Poison and Disease', 'Disguise Self', 'Divine Favor', 'Faerie Fire', 'False Life', 'Fog Cloud', 'Guiding Bolt', 'Healing Word', 'Heroism', 'Identify', 'Inflict Wounds', 'Protection from Evil and Good', 'Purify Food and Drink', 'Sanctuary', 'Shield of Faith', 'Sleep', 'Speak with Animals', 'Thunderwave'],
        2: ['Aid', 'Augury', 'Barkskin', 'Blindness/Deafness', 'Borrowed Knowledge', 'Calm Emotions', 'Continual Flame', 'Enhance Ability', 'Find Traps', 'Flaming Sphere', 'Gentle Repose', 'Gust of Wind', 'Hold Person', 'Lesser Restoration', 'Locate Object', 'Magic Weapon', 'Mirror Image', 'Moonbeam', 'Pass without Trace', 'Prayer of Healing', 'Protection from Poison', 'Ray of Enfeeblement', 'Scorching Ray', 'See Invisibility', 'Shatter', 'Silence', 'Spike Growth', 'Spiritual Weapon', 'Suggestion', 'Warding Bond', 'Zone of Truth'],
        3: ['Aura of Vitality', 'Beacon of Hope', 'Bestow Curse', 'Blink', 'Call Lightning', 'Clairvoyance', 'Create Food and Water', 'Crusader\'s Mantle', 'Daylight', 'Dispel Magic', 'Fast Friends', 'Feign Death', 'Fireball', 'Glyph of Warding', 'Incite Greed', 'Leomund\'s Tiny Hut', 'Life Transference', 'Magic Circle', 'Mass Healing Word', 'Meld into Stone', 'Motivational Speech', 'Nondetection', 'Plant Growth', 'Protection from Energy', 'Remove Curse', 'Revivify', 'Sending', 'Sleet Storm', 'Speak with Dead', 'Spirit Guardians', 'Spirit Shroud', 'Tongues', 'Vampiric Touch', 'Water Walk', 'Wind Wall'],
        4: ['Arcane Eye', 'Aura of Life', 'Aura of Purity', 'Banishment', 'Blight', 'Compulsion', 'Confusion', 'Control Water', 'Death Ward', 'Dimension Door', 'Divination', 'Dominate Beast', 'Freedom of Movement', 'Grasping Vine', 'Greater Invisibility', 'Guardian of Faith', 'Ice Storm', 'Locate Creature', 'Otiluke\'s Resilient Sphere', 'Polymorph', 'Stone Shape', 'Stoneskin', 'Wall of Fire'],
        5: ['Antilife Shell', 'Circle of Power', 'Commune', 'Contagion', 'Dawn', 'Destructive Wave', 'Dispel Evil and Good', 'Dominate Person', 'Flame Strike', 'Geas', 'Greater Restoration', 'Hallow', 'Hold Monster', 'Holy Weapon', 'Insect Plague', 'Legend Lore', 'Mass Cure Wounds', 'Mislead', 'Modify Memory', 'Planar Binding', 'Raise Dead', 'Rary\'s Telepathic Bond', 'Scrying', 'Tree Stride']
    },
    Druid: {
    ...
    Paladin: {
        ...
        1: ['Armor of Agathys', 'Bane', 'Bless', 'Ceremony', 'Command', 'Compelled Duel', 'Cure Wounds', 'Detect Evil and Good', 'Detect Magic', 'Detect Poison and Disease', 'Divine Favor', 'Ensnaring Strike', 'Heroism', 'Hunter\'s Mark', 'Protection from Evil and Good', 'Purify Food and Drink', 'Sanctuary', 'Searing Smite', 'Shield of Faith', 'Sleep', 'Thunderous Smite', 'Wrathful Smite'],
        2: ['Aid', 'Branding Smite', 'Calm Emotions', 'Find Steed', 'Gentle Repose', 'Hold Person', 'Lesser Restoration', 'Locate Object', 'Magic Weapon', 'Misty Step', 'Moonbeam', 'Prayer of Healing', 'Protection from Poison', 'See Invisibility', 'Spiritual Weapon', 'Warding Bond', 'Zone of Truth'],
        3: ['Aura of Vitality', 'Beacon of Hope', 'Bestow Curse', 'Blinding Smite', 'Counterspell', 'Create Food and Water', 'Crusader\'s Mantle', 'Daylight', 'Dispel Magic', 'Elemental Weapon', 'Fear', 'Haste', 'Hypnotic Pattern', 'Magic Circle', 'Nondetection', 'Plant Growth', 'Protection from Energy', 'Remove Curse', 'Revivify', 'Spirit Guardians', 'Spirit Shroud'],
        4: ['Aura of Life', 'Aura of Purity', 'Banishment', 'Compulsion', 'Death Ward', 'Dimension Door', 'Dominate Beast', 'Find Greater Steed', 'Freedom of Movement', 'Guardian of Faith', 'Ice Storm', 'Locate Creature', 'Otiluke\'s Resilient Sphere', 'Staggering Smite', 'Stoneskin'],
        5: ['Banishing Smite', 'Circle of Power', 'Cloudkill', 'Commune', 'Commune with Nature', 'Destructive Wave', 'Dispel Evil and Good', 'Dominate Person', 'Flame Strike', 'Geas', 'Hold Monster', 'Holy Weapon', 'Raise Dead', 'Scrying', 'Tree Stride', 'Wall of Force']
    },
    Ranger: {
